# Converted from: 04_inventory_stage_load(5).ipynb
...
# %% [code] Cell 2
# Configuration
source_dir = "/Volumes/demo-external-catalog/default/incremental_load/inventory_data/source/"
archive_dir = "/Volumes/demo-external-catalog/default/incremental_load/inventory_data/archive/"
stage_table = "`demo-external-catalog`.default.inventory_stage"
error_table = "`demo-external-catalog`.default.inventory_errors"
