# Converted from: 06_data_validation(5).ipynb
...
# %% [code] Cell 2
# Configuration
orders_stage = "`demo-external-catalog`.default.orders_stage"
customers_stage = "`demo-external-catalog`.default.customers_stage"
products_stage = "`demo-external-catalog`.default.products_stage"
inventory_stage = "`demo-external-catalog`.default.inventory_stage"
shipping_stage = "`demo-external-catalog`.default.shipping_stage"
validation_results_table = "`demo-external-catalog`.default.validation_results"
