# Converted from: 02_customers_stage_load(5).ipynb
...
# %% [code] Cell 2
# Configuration
source_dir = "/Volumes/demo-external-catalog/default/incremental_load/customers_data/source/"
archive_dir = "/Volumes/demo-external-catalog/default/incremental_load/customers_data/archive/"
stage_table = "`demo-external-catalog`.default.customers_stage"
error_table = "`demo-external-catalog`.default.customers_errors"
