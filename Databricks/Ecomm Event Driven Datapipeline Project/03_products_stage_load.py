# Converted from: 03_products_stage_load(5).ipynb
...
# %% [code] Cell 2
# Configuration
source_dir = "/Volumes/demo-external-catalog/default/incremental_load/products_data/source/"
archive_dir = "/Volumes/demo-external-catalog/default/incremental_load/products_data/archive/"
stage_table = "`demo-external-catalog`.default.products_stage"
error_table = "`demo-external-catalog`.default.products_errors"
